...
public class CustomerInfor extends JPanel implements ActionListener,
	...
	private JButton p4_jb1, p4_jb2, p4_jb3, p4_jb4, right, left;
	...
	private String number,place,allRow;
	...
	public void actionPerformed(ActionEvent arg0) {
		if (arg0.getSource().equals(p4_jb1)) {
			...
			if (rowNum == -1) {
				...
				if (JOptionPane.showConfirmDialog(this, "确定要删除吗", "删除信息",
						JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE) == JOptionPane.YES_OPTION) {
					String customerId = (String) cm.getValueAt(rowNum, 0);
					String[] params = { customerId };
					String tuangouhaoName = cm
							.getDataById("tuangouhao", params);
	...
	private void changeCombo() {
		...
		int numPerPage = Integer.parseInt((String) recordNum_combobox
				.getSelectedItem());
		if (maxNum - cursorIndexOld < numPerPage
				| (maxNum - cursorIndexOld == numPerPage)
				& (maxNum - cursorIndex < maxNum)) {
			disableRight();
		} else {
			enableRight();
		}
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (e.getSource() == right) {
			...
			if (cursorIndexOld > 0) {
				...
				cursorIndexOld = cm.querySimpleInfor(place, cursorIndex + 1,
						number, false) - 1;
				querry();
